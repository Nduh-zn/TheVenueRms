...
<div class="banner-top">
			...
			<div class="contact-bnr-w3-agile">
				<ul>
					<li><i class="fa fa-envelope" aria-hidden="true"></i><a href="mailto:info@example.com">info@thevenue.com</a></li>
					<li><i class="fa fa-phone" aria-hidden="true"></i>+ (031)222-44-55</li>	
					<li class="s-bar">
						<div class="search">
		...
		<div class="container">
			<nav class="navbar navbar-default">
				<div class="navbar-header navbar-left">
					...
					<h1><a class="navbar-brand" href="index.php">THE <span>VENUE</span><p class="logo_w3l_agile_caption">Your Favourite Hotel</p></a></h1>
				</div>
	...
	<div id="home" class="w3ls-banner">
		...
		<div class="slider">
			<div class="callbacks_container">
				...
				<a href="#" class="menu__link" data-toggle="modal" data-target="#myModal">Explore</a>
			</div>
								</div>	
							</div>
						</div>
 	...
 	<div class="about-wthree" id="about">
		  <div class="container">
				   <div class="ab-w3l-spa">
                            <h3 class="title-w3-agileits title-black-wthree">About THE VENUE</h3> 
...
<section class="contact-w3ls" id="contact">
	<div class="container">
		...
		<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
			...
			<p class="contact-agile1"><strong>Phone :</strong> (031)222-44-55</p>
			<p class="contact-agile1"><strong>Email :</strong> <a href="mailto:name@example.com">info    @thevenue.com</a></p>
			<p class="contact-agile1"><strong>Address :</strong>21 Long Beach, Durban</p>
...
<!-- /contact -->
			<div class="copy">
		        <p>© 2019 <a href="index.php">The Venue</a> </p>
		    </div>
<!--/footer -->
<!-- js -->
