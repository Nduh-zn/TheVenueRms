        ...
        <div class="mn-content fixed-sidebar">
            ...
            <aside id="slide-out" class="side-nav white fixed">
                ...
                <ul class="sidebar-menu collapsible collapsible-accordion" data-collapsible="accordion" style="">
                    <li>&nbsp;</li>
                    <li class="no-padding"><a class="waves-effect waves-grey" href="https://www.noidatut.com" target="_blank"><i class="material-icons">account_box</i>Dr Tutorial NoidaTut</a></li>
          ...
          <div class="footer">
                    <p class="copyright"><a href="http://www.noidatut.com/">Dr Tutorial NoidaTut </a></p>
