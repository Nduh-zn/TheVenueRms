                    ...
                    <li class="no-padding">
                        ...
                        <div class="collapsible-body">
                            <ul>
                                ...
                                <li><a href="manageRoomType.php">Manage Room Types</a></li>
                            </ul>
                        </div>
                    </li>
                    <li class="no-padding">
                        <a class="collapsible-header waves-effect waves-grey"><i class="material-icons">apps</i>Roles<i class="nav-drop-icon material-icons">keyboard_arrow_right</i></a>
                        <div class="collapsible-body">
                            <ul>
