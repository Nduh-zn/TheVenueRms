...
<li class="no-padding"><a class="waves-effect waves-grey" href="https://www.noidatut.com"><i class="material-icons">account_box</i>Dr Tutorial NoidaTut</a></li>
                </ul>
                <div class="footer">
                    <p class="copyright">Brought to You Live By<a href="http://www.noidatut.com">Dr Tutorial NoidaTut</a></p>
